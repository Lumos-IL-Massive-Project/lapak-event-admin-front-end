        ...
        <div className="flex flex-wrap mt-2">
          <div className="w-40">
            <ul>
              ...
              <li className="mb-1">Nama Promo</li>
              <li className="mb-1">Waktu Mulai</li>
              <li className="mb-1">Waktu Berakhir</li>
            </ul>
          </div>
          <div className="w-20">
            <ul>
              ...
              <li className="mb-1">
                <input type="radio" name="" id="mulaiAz" className="mr-1" />
                <label htmlFor="mulaiAz">A-Z</label>
              </li>
              <li className="mb-1">
                <input type="radio" name="" id="idNaik" className="mr-1" />
                <label htmlFor="idNaik">Naik</label>
