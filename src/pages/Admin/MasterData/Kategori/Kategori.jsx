                ...
                <div className="mb-4 p-3">
                  ...
                  <div className="float-right">
                    <input
                      ...
                      id="username"
                      autocomplete="off"
                      className="rounded-md border border-[#7A51E3] py-1.5 pl-3 text-[#7A51E3] placeholder:text-[#7A51E3] focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 w-50 mr-2"
                    />
